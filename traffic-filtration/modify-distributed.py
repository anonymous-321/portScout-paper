...
def replace_and_save_pcap(directory, output_directory):
    ...
    for filename in os.listdir(directory):
        ...
        if filename.endswith('.pcap'):
            ...
            # random_ip_2 = f"242.42.11.{random.randint(50, 99)}"
            ...
            for pkt in packets:
                ...
                if IP in pkt:
                    pkt[IP].src = pkt[IP].src.replace('192.168.18.', '55.142.61.')
                    pkt[IP].dst = pkt[IP].dst.replace('192.168.18.', '55.142.61.')
...
if __name__ == "__main__":
    ...
    input_directory_path = '/home/khattak01/Desktop/thest-test/scans-traffic/ubuntu-traffic/evasion-technique-filtered-traffic/distibuted'

    # Replace this with the path to the directory where you want to save modified pcap files
    output_directory_path = '/home/khattak01/Desktop/thest-test/scans-traffic/ubuntu-traffic/evasion-technique-filtered-traffic/distibuted'
