...
if __name__ == "__main__":
    ...
    input_directory_path = '/home/khattak01/Desktop/thest-test/scans-traffic/ubuntu-traffic/evasion-technique-unfiltered-traffic/test'

    # Replace this with the path to the directory where you want to save modified pcap files
    output_directory_path = '/home/khattak01/Desktop/thest-test/scans-traffic/ubuntu-traffic/evasion-technique-filtered-traffic'
