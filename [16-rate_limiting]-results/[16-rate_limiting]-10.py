...
def update_alert_ips(ip):
    ...
    json_file_path = 'alert_ips-10.json'
    try:
...
if __name__ == "__main__":
    ...
    # files = ['/home/khattak01/Desktop/thesis/dataset/scans-traffic/filtered-traffic/ubuntu-traffic/simple-scans-modified-traffic/filtered_nmap_top-ports_tcp-syn-.pcap']
