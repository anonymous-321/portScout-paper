...
def extract_and_save_packets(input_file_path, output_file_path, num_packets, skip_packets):
    try:
        extracted_packets = []

        # Open the pcap file using PcapReader
        with PcapReader(input_file_path) as pcap_reader:
            # Skip the first 'skip_packets' packets
...
num_packets_to_extract = 100000
skip_packets = 500000
input_file_path = '/home/khattak01/Desktop/thesis/dataset/BenignTraffic/BenignTraffic.pcap'
output_file_path = f'BenignTraffic-packets-{num_packets_to_extract}.pcap'

extract_and_save_packets(input_file_path, output_file_path, num_packets_to_extract, skip_packets)
